// STEP 1: Add these state variables after the mergeError state (around line 95-100)
// ============================================================================
...
// STEP 2: Add this function call in the React.useEffect (around line 110-115)
// ============================================================================
...
// Then update the useEffect to call it:
React.useEffect(() => {
  loadVoices();
  loadProjects();
  loadCustomVoices();  // ADD THIS LINE
}, []);


// STEP 3: Add these handler functions after the handleMergeAudio function (around line 250)
// ============================================================================
...
// STEP 4: Update the "+ Create Custom Voice" button in the voice-library section (around line 800)
// REPLACE THIS:
...
// STEP 5: Add the custom voice modal JSX right after the Voice Library filters section (after line 900)
// ============================================================================
...
// STEP 6: Add custom voices display in the voice-library page (after the main voices grid, around line 1000)
// ============================================================================
      ...
      {customVoices.map((voice) => (
        <div key={voice.id} className="voice-card custom-voice-card">
          ...
          <div className="voice-details">
            ...
            {voice.voiceName && (
              <div className="detail-item">
                <span className="detail-label">Base Voice:</span>
